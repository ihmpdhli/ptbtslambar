...
<script>
    ...
    var informasi = '<table class="table table-borderless"><tr><td>Provider</td><td width="0%">:</td><td width="100%">{{ $data->provider}}</td></tr> <tr><td>Posisi</td><td>:</td><td><a href="/towerbts/detail/{{$data->bts}}">{{ $data->posisi}}</a></td></tr> <tr><td>Kecamatan</td><td>:</td><td>{{ $data->kecamatan}}</td></tr> <tr><td>Alamat</td><td>:</td><td>{{ $data->alamat}}</td></tr></table>';
