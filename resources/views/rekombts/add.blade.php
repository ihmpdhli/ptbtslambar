...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-12">
            <div class="col-sm-12">
                <h6 class="m-12 text-dark"><a href="/rekombts">Transaksi</a> / <a href="/rekombts">Rekomendasi BTS</a> / Tambah Data</h6>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <!-- form -->
                    <form action="/rekombts/insert" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="nama_pemohon" class="form-control" value="{{ old('nama_pemohon')}}" placeholder="Masukkan nama pemohon">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="no_telp" class="form-control" value="{{ old('no_telp')}}" placeholder="Masukkan nomor telephone">
                                        <div class="text-danger">
                                            @error('no_telp')
                                            {{ $message}}
                                            @enderror
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-10"><label>Foto Copy Akta Pendirian Usaha dari Notaris *</label></div>
                                            <div class="col-md-2"><span class="float-right text-danger">Format file: .pdf | Max: 2MB</span></div>
                                        </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-10"><label>Jaminan Asuransi Bagi Masyarakat dengan Radius Ketinggian Tower *</label></div>
                                            <div class="col-md-2"><span class="float-right text-danger">Format file: .pdf | Max: 2MB</span></div>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="tinggi_tower" id="tinggi_tower" value="{{ old('tinggi_tower')}}" class="form-control" placeholder="Masukkan tinggi tower (meter)">
                                        <div class="text-danger">
                                            @error('tinggi_tower')
                                            {{ $message}}
                                            @enderror
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="luas_tanah" id="luas_tanah" value="{{ old('luas_tanah')}}" class="form-control" placeholder="Masukkan luas tanah (meter persegi)">
                                        <div class="text-danger">
                                            @error('luas_tanah')
                                            {{ $message}}
                                            @enderror
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_pengajuan" class="form-control" placeholder="Masukkan tanggal pengajuan">
                                        <div class="text-danger">
                                            @error('tgl_pengajuan')
                                            {{ $message}}
                                            @enderror
            ...
            <script>
                ...
                var curLocation = [-5.036737688172696, 104.08239063312324];
