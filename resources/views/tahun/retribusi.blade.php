...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-12">
            <div class="col-sm-12">
                <h6 class="m-12 text-dark"><a href="/tahun">Transaksi</a> / <a href="/tahun">Tahun</a> / Retribusi BTS</h6>
            </div>
        </div>
    </div>
</div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($data->status == 2)
                                        <div class="text-warning"><b>Menunggu</b></div>
                                        @elseif($data->status == 1)
                                        <div class="text-success"><b>Sudah Bayar</b></div>
                                        @elseif($data->status == 0)
                                        <div class="text-danger"><b>Belum Bayar</b></div>
                                        @endif
                                    </td>
                                    @else
                                    @endif
